...
-- 	การลาแต่ละครั้ง
CASE 
 WHEN  DATE(NOW()) <  (SELECT leave_limit.Date_stop FROM leave_limit WHERE 1 ORDER BY limit_ID  DESC LIMIT 1) AND (employee.Empstatus_ID=201 OR employee.Empstatus_ID=202 OR employee.Empstatus_ID=203)
THEN
...
0
 ...
 THEN
        ...
        -- ค่าคงเหลือ
			...
			WHEN   DATE(NOW()) <  (SELECT leave_limit.Date_stop FROM leave_limit WHERE 1 ORDER BY limit_ID  DESC LIMIT 1)  AND employee.Empstatus_ID=201  
			THEN  	
       ...
       WHEN  DATE(NOW()) <  (SELECT leave_limit.Date_stop FROM leave_limit WHERE 1 ORDER BY limit_ID  DESC LIMIT 1)  AND (employee.Empstatus_ID=202 OR employee.Empstatus_ID=203)  AND
